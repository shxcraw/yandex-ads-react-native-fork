...
class InterstitialAd {
  ...
  constructor(adId) {
    ...
    this._subscriptions.push(this._eventEmitter.addListener('RNYandexMobileAds-Interstitial-onAdDeleted', () => {
      return this.delete();
    }));
  }
  ...
  set onAdShown(onAdShown_) {
    ...
    if (this._onAdShown !== null) {
      this._subscriptions.push(this._eventEmitter.addListener('RNYandexMobileAds-Interstitial-onAdShown', this.createListenerFunction(this._onAdShown)));
    }
  }
  ...
  set onAdFailedToShow(onAdFailedToShow_) {
    ...
    if (this._onAdFailedToShow != null) {
      this._subscriptions.push(this._eventEmitter.addListener('RNYandexMobileAds-Interstitial-onAdFailedToShow', this.createListenerFunction(event => {
  ...
  set onAdDismissed(onAdDismissed_) {
    ...
    if (this._onAdDismissed != null) {
      this._subscriptions.push(this._eventEmitter.addListener('RNYandexMobileAds-Interstitial-onAdDismissed', this.createListenerFunction(this._onAdDismissed)));
    }
  }
  ...
  set onAdClicked(onAdClicked_) {
    ...
    if (this._onAdClicked !== null) {
      this._subscriptions.push(this._eventEmitter.addListener('RNYandexMobileAds-Interstitial-onAdClicked', this.createListenerFunction(this._onAdClicked)));
    }
  }
  ...
  set onAdImpression(onAdImpression_) {
    ...
    if (this._onAdImpression !== null) {
      this._subscriptions.push(this._eventEmitter.addListener('RNYandexMobileAds-Interstitial-onAdImpression', this.createListenerFunction(event => {
  ...
  async show() {
    try {
      ...
      await _YandexMobileAdsModule.default.YandexInterstitialAdModule.showAd(this._id);
    } catch (error) {
      return Promise.reject(error);
    }
  }
